...
@frappe.whitelist()
def get_sales_non_inv(company=None):
    if company==None:
    ...
    if company_number:
        ...
        sales_doc = frappe.db.get_list('Sales Invoice',filters={'company':company_name,'is_return':0, 'update_stock':0, 'docstatus':1},fields=['*'])
